...
import { JumbotronLayout } from '../components/layout'

export default props => (
  <JumbotronLayout {...props}>
    <Segment inverted textAlign="center" vertical style={{ minHeight: 640, padding: '1em 0em' }}>
      <Container text>
        <Header
          as="h1"
          content="Game Group Manager"
          inverted
      ...
      <Grid celled="internally" columns="equal" stackable>
        <Grid.Row textAlign="center">
          ...
          <Grid.Column style={{ paddingBottom: '5em', paddingTop: '5em' }}>
            ...
            <p style={{ fontSize: '1.33em' }}>
              <Image avatar src="/static/steve-avatar-dark.png" />
